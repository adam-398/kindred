...
/**
 * Composable function which displays a book card used for the audiobook suggestion flow.
 *
 * @param audiobook to display.
 * @param isSelected whether the audiobook is selected or not.
 * @param onClick the action to perform when the card is clicked.
 */
@Composable
fun AudiobookSelectCard(
    audiobook: Audiobook,
    isSelected: Boolean,
    onClick: () -> Unit
) {
